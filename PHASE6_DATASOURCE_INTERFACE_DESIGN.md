...
> 状态：**Phase 6.1 已实现** | main: `ae44fcb` | Phase 6.1 分支: `feat/phase6.1-datasource-mvp`
...
[UNKNOWN] request_id / data_provenance 全局 schema 化 — Phase 6.1 仅要求新 DataSource 输出包含，未修改全局 required
```
...
```
main HEAD:      ae44fcb
Phase 6.1 分支: feat/phase6.1-datasource-mvp (未 commit / 未 push)
Tests:          165 passed (原 127 + 新增 38), 0 skipped, 0 xfailed, 0 deselected
...
- request_id / data_provenance 全局 schema 迁移
- 多源交叉验证、自动时效窗口、重试与退避
