...
项目英文名：Meridian Research Engine 2.0（经纬投研引擎 2.0）  
GitHub 仓库：`pencilyu1102-pixel/meridian-research-engine-v2`  
仓库目录名：`meridian-research-engine-v2`

> **Meridian Research Engine 2.0 不是荐股系统，不自动交易，不提供投资建议，不预测股价，不承诺收益。**
> 它的目标是帮助使用者建立更有纪律、更可审计、更可证伪、更可复盘的 AI 投研工作流。

> 一个融合宏观周期、板块轮动、数据审计、基本面驱动模型、竞争份额模型、隐含预期反推、反向论证、证伪框架与 Gatekeeper 准出校验的 AI 投研工作流。

Meridian Research Engine 2.0（经纬投研引擎 2.0）是一套面向个人投资者和研究者的**全球股票通用买方研究框架**，兼容美股、A股、港股、欧洲、日本及其他全球市场的结构化投研流程。
...
本次升级引入**全球股票通用买方研究框架**，新增 7 个核心模块文档：
...
| 报告准出机制（Gatekeeper v2） | 三层检查 + 三档准出，防止数据不全的报告被交付 |
...
- [x] 增加 Gatekeeper v2 准出校验（三层 + 三档 + 三模式 + 10 条降级规则）
...
当前版本：**v1.0-beta**（Meridian Research Engine 2.0 首发版）

| 版本 | 日期 | 主要变更 |
|---|---|---|
| （上游）v1.1-pricelevel | 上游初始版本 | 九代理架构 + Price Level Engine + 基础 Gatekeeper |
| **v1.0-beta** | 2026-07-03 | **Meridian Research Engine 2.0 首发版**：市场/行业适配器、基本面驱动模型、竞争份额模型、隐含预期反推、证伪框架、数据质量清单、Gatekeeper v2（三层/三档/三模式）、25 规范章节模板、综合测试套件 |
...
本项目是 [**pencilyu1102-pixel/golden-research-engine**](https://github.com/pencilyu1102-pixel/golden-research-engine) 的 fork，其上游为 MIT 开源项目 [AI Berkshire](https://github.com/xbtlin/ai-berkshire)（作者 xbtlin）。并非原项目官方版本，也不代表原作者或维护者立场。

| 层级 | 仓库 | 说明 |
|---|---|---|
| 上游上游 | [`xbtlin/ai-berkshire`](https://github.com/xbtlin/ai-berkshire) | MIT License，原作者 xbtlin |
| 直接上游 | [`pencilyu1102-pixel/golden-research-engine`](https://github.com/pencilyu1102-pixel/golden-research-engine) | 基于 AI Berkshire 二次开发，含全球框架 v1.0 |
| **本仓库** | **`pencilyu1102-pixel/meridian-research-engine-v2`** | **本 fork，v1.0-beta** |

在本仓库中，在原项目基础上进行了全球框架升级、市场/行业适配器、基本面驱动模型、竞争份额模型、Gatekeeper v2 准出校验、报告模板规范化和综合测试等方向的重构与扩展。
