...
Meridian Research Engine 2.0 用宏观周期、板块轮动、数据审计、基本面驱动模型、竞争份额模型、市场隐含预期反推、Bear Case 和 Gatekeeper 准出校验，把一篇 AI 投研报告从"看起来有道理"推进到"可以被审计、可以被反驳、可以被复盘"。
